...
while (adicionarMais != "não") {
    if (frutas.length === 0 && laticinios.length === 0 && doces.length === 0 && congelados.length === 0) {
        ...
        adicionarMais = prompt("Você deseja adicionar uma comida na lista de compras? Responda 'sim' ou 'não' ou 'remover'.");
    }


    while (adicionarMais != "sim" && adicionarMais != "não" && adicionarMais != "remover") { //Enquanto o texto lido for  diferente de "sim" e de "não" e de "remover", exibir que não foi reconhecido e perguntar novamente
